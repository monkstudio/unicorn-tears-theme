...
jQuery(document).ready(function ($) {
  ...
  $lightbox = $('.lightbox'),
      ...
      currentWidth = $(window).width(); //mobile menu
  ...
  function viewportHeight() {
    if ($(window).width() !== currentWidth) {
      ...
      document.documentElement.style.setProperty('--header', _viewportHeight + 'px');
    }
  }
  ...
  */
  ...
  AOS.init(); //https://stackoverflow.com/questions/4817029/whats-the-best-way-to-detect-a-touch-screen-device-using-javascript
